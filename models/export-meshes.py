...
# based on 'export-sprites.py' and 'glsprite.py' from TCHOW Rainbow; code used 
...
# reads 'robot.blend' and writes '../dist/meshes.blob' (meshes) and 
# '../dist/scene.blob' (scene in layer 1)
...
to_write = [
    ...
    'Balloon3.001',
    'Crate',
    'Crate.001', # duplicates of Crate, perhaps not necessary
    'Crate.002',
    'Crate.003',
    'Crate.004',
    'Crate.005',
...
strings = b''
# these map from the *mesh* name of our the written objects to the *object* 
